...
export class Guest3 extends AWObj {
  ...
  private gHead = AWResourceManager.getInstance().resources('guest_head3Img');
  ...
  initSetting() {
    ...
    this.translatePosition = new PointVector(this.stage.width - 150, 20);
  }
}
