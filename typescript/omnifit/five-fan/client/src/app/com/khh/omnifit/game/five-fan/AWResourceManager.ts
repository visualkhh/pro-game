...
//singletone pattern
  ...
  private constructor() {
    ...
    const fan_01Img = new Image(); fan_01Img.src = 'assets/image/fan_01.png';
    const head_01Img = new Image(); head_01Img.src = 'assets/image/head_01.png';
    const head_02Img = new Image(); head_02Img.src = 'assets/image/head_02.png';
    ...
    this.setResources('fan_01Img', fan_01Img);
    this.setResources('head_01Img', head_01Img);
    this.setResources('head_02Img', head_02Img);
