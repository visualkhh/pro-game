...
//singletone pattern
  ...
  private constructor() {
    ...
    this._resources.set('armImg', armImg);
    this._resources.set('btn1levelImg', btn1levelImg);
    this._resources.set('btn2levelImg', btn2levelImg);
    this._resources.set('btn3levelImg', btn3levelImg);
